...
const ROOMS = {
  amber: {
    wall:'#231a0f', floor:'#3a2410', win:'rgba(245,195,90,0.5)',
    curtain:'rgba(120,60,20,0.7)', glow:'rgba(245,170,45,0.3)',
    pc:'#c47838', accent:'#f0b84a', duvet:'#7a3820',
    lampshade:'rgba(220,160,60,0.85)', lampglow:'rgba(245,195,80,0.5)',
    rug:'rgba(180,100,40,0.3)',
    alias:'the midnight reader',
    quote:'"I read to know I am not alone."',
    track:'Kind of Blue', artist:'Miles Davis',
    s1:[{c:'#8b2020',h:72,t:'Middlemarch'},{c:'#1a3a5c',h:58,t:"Giovanni's Room"},{c:'#2d5a1a',h:76,t:'Beloved'},{c:'#6b1a3a',h:54,t:'Pachinko'},{c:'#4a3a10',h:66,t:'The Goldfinch'},{c:'#1a4a3a',h:61,t:'On Earth'},{c:'#5c2a0a',h:68,t:'Wide Sargasso'},{c:'#2a2a5c',h:51,t:'A Room'}],
    s2:[{c:'#3a1a10',h:61,t:'The Hours'},{c:'#1a1a1a',h:56,t:'Beloved'},{c:'#4a2a18',h:68,t:'Sebald'},{c:'#1a3a2a',h:51,t:'Sontag'},{c:'#2a1a3a',h:64,t:'Borges'},{c:'#3a2a08',h:58,t:'Woolf'},{c:'#1a2a1a',h:54,t:'Baldwin'}]
  },
  blue: {
    wall:'#0c1520', floor:'#0a1018', win:'rgba(118,184,224,0.48)',
    curtain:'rgba(20,40,80,0.75)', glow:'rgba(65,148,212,0.22)',
    pc:'#3a7a9a', accent:'#78c0e0', duvet:'#1a2a4a',
    lampshade:'rgba(80,140,200,0.8)', lampglow:'rgba(100,170,220,0.45)',
    rug:'rgba(30,60,120,0.25)',
    alias:'stranger no. 7',
    quote:'"The unexamined life is not worth living."',
    track:'Kid A', artist:'Radiohead',
    s1:[{c:'#1a1a3a',h:74,t:'Being & Time'},{c:'#2a1a1a',h:56,t:'The Stranger'},{c:'#0a2a1a',h:68,t:'Nausea'},{c:'#3a2a0a',h:51,t:'Nietzsche'},{c:'#1a2a3a',h:64,t:'Meditations'},{c:'#2a0a2a',h:58,t:'Camus'},{c:'#0a1a2a',h:71,t:'Kierkegaard'}],
    s2:[{c:'#0a0a2a',h:56,t:'Kafka'},{c:'#2a1a2a',h:64,t:'Dostoevsky'},{c:'#1a2a1a',h:48,t:'Chekhov'},{c:'#2a0a0a',h:68,t:'Woolf'},{c:'#1a1a2a',h:54,t:'Beckett'},{c:'#0a2a2a',h:61,t:'Plath'},{c:'#2a2a1a',h:58,t:'Pessoa'}]
  },
  green: {
    wall:'#101808', floor:'#0c1608', win:'rgba(148,204,88,0.44)',
    curtain:'rgba(30,70,20,0.7)', glow:'rgba(108,178,48,0.2)',
    pc:'#5a9a28', accent:'#98d050', duvet:'#2a4a1a',
    lampshade:'rgba(120,180,60,0.8)', lampglow:'rgba(140,200,70,0.4)',
    ...
    track:'Carrie & Lowell', artist:'Sufjan Stevens',
    s1:[{c:'#2a4a1a',h:68,t:'Mary Oliver'},{c:'#3a1a2a',h:56,t:'Ariel'},{c:'#1a3a2a',h:74,t:'Devotions'},{c:'#4a3a0a',h:51,t:'Milk & Honey'},{c:'#1a1a3a',h:64,t:'Wild Geese'},{c:'#3a2a1a',h:58,t:'Rupi Kaur'},{c:'#1a3a1a',h:70,t:'Sun & Flowers'}],
    s2:[{c:'#2a1a3a',h:54,t:'Folklore'},{c:'#1a2a2a',h:61,t:'Punisher'},{c:'#3a1a1a',h:66,t:'Fleet Foxes'},{c:'#1a1a2a',h:48,t:'Big Thief'},{c:'#2a3a1a',h:58,t:'Bon Iver'},{c:'#1a2a1a',h:64,t:'boygenius'},{c:'#3a2a2a',h:54,t:'Phoebe B'}]
  }
};
...
document.getElementById('qotn-text').textContent = quotes[Math.floor(Math.random() * quotes.length)];
...
function renderTags(type) {
  ...
  container.innerHTML = tags[type].map((t, i) =>
...
══════════════════════════════════ */
const DOOR_PALETTES = [
  { id:'crimson', door:'#3d1515', crack:'#e87070', wall:'#1f0e0e', floor:'#2e1010', win:'rgba(230,110,110,0.5)',  glow:'rgba(200,70,70,0.25)',   pc:'#b84040', accent:'#e87070', duvet:'#5a1a1a', lamp:'rgba(200,100,80,0.85)',  lampg:'rgba(220,110,80,0.45)',  rug:'rgba(160,50,50,0.28)'  },
  { id:'amber',   door:'#5c3318', crack:'#f5c060', wall:'#231a0f', floor:'#3a2410', win:'rgba(245,195,90,0.5)',   glow:'rgba(245,170,45,0.3)',   pc:'#c47838', accent:'#f0b84a', duvet:'#7a3820', lamp:'rgba(220,160,60,0.85)', lampg:'rgba(245,195,80,0.5)',  rug:'rgba(180,100,40,0.3)'  },
  { id:'violet',  door:'#2a1838', crack:'#c090f0', wall:'#180e24', floor:'#200e30', win:'rgba(180,130,240,0.5)',  glow:'rgba(150,90,220,0.25)',  pc:'#9060c0', accent:'#c090f0', duvet:'#3a1a5a', lamp:'rgba(160,100,220,0.8)', lampg:'rgba(180,120,240,0.45)',rug:'rgba(100,50,160,0.28)' },
  { id:'blue',    door:'#1c2c3a', crack:'#80c4e8', wall:'#0c1520', floor:'#0a1018', win:'rgba(118,184,224,0.48)', glow:'rgba(65,148,212,0.22)',  pc:'#3a7a9a', accent:'#78c0e0', duvet:'#1a2a4a', lamp:'rgba(80,140,200,0.8)',  lampg:'rgba(100,170,220,0.45)',rug:'rgba(30,60,120,0.25)'  },
  { id:'green',   door:'#1c2e14', crack:'#a0d060', wall:'#101808', floor:'#0c1608', win:'rgba(148,204,88,0.44)',  glow:'rgba(108,178,48,0.2)',   pc:'#5a9a28', accent:'#98d050', duvet:'#2a4a1a', lamp:'rgba(120,180,60,0.8)',  lampg:'rgba(140,200,70,0.4)',  rug:'rgba(60,110,30,0.28)'  },
  { id:'rose',    door:'#3a1828', crack:'#f0a0c0', wall:'#200e18', floor:'#2a1020', win:'rgba(240,160,190,0.5)',  glow:'rgba(210,100,150,0.25)', pc:'#c05080', accent:'#f0a0c0', duvet:'#5a1a38', lamp:'rgba(210,130,160,0.8)', lampg:'rgba(230,150,180,0.45)',rug:'rgba(160,70,110,0.28)' },
  { id:'teal',    door:'#0e2828', crack:'#60d4c8', wall:'#081818', floor:'#061a1a', win:'rgba(90,210,200,0.48)',  glow:'rgba(50,180,170,0.22)',  pc:'#30a09a', accent:'#60d4c8', duvet:'#0e3030', lamp:'rgba(60,180,170,0.8)',  lampg:'rgba(80,210,200,0.45)', rug:'rgba(20,110,100,0.28)' },
  { id:'gold',    door:'#3a2c08', crack:'#f0d050', wall:'#201808', floor:'#281e06', win:'rgba(240,210,80,0.5)',   glow:'rgba(210,180,40,0.25)',  pc:'#c0a020', accent:'#f0d050', duvet:'#503808', lamp:'rgba(210,180,60,0.85)', lampg:'rgba(240,210,80,0.45)',  rug:'rgba(160,130,20,0.3)'  },
];
...
function renderPaletteSwatches() {
  ...
  if (!wrap) return;
  wrap.innerHTML = DOOR_PALETTES.map(p =>
...
function applyDoorPreview(p) {
  const setEl = (id, prop, val) => { const el = document.getElementById(id); if (el) el.style[prop] = val; };
...
function generateShelfBooks(p) {
  const palette = [p.door, p.accent + '55', '#8b2020','#1a3a5c','#2d5a1a','#4a3a10','#1a4a3a','#5c2a0a','#2a2a5c','#3a1a10','#0a2a1a','#2a0a2a'];
...
function ndAddTag(type) {
  ...
  newDoorTags[type].push(val); ndRenderTags(type);
  inp.value = ''; inp.focus();
}
function ndRemoveTag(type, i) { newDoorTags[type].splice(i,1); ndRenderTags(type); }
function ndRenderTags(type) {
  const id = type === 'book' ? 'ndBookTags' : 'ndMusicTags';
  const el = document.getElementById(id); if (!el) return;
  el.innerHTML = newDoorTags[type].map((t,i) =>
    `<div class="cdm-tag">${t}<button onclick="ndRemoveTag('${type}',${i})">×</button></div>`
  ).join('');
}
function ndTagEnter(e, type) { if (e.key === 'Enter') { e.preventDefault(); ndAddTag(type); } }

function updateNameplate() {
  const val = document.getElementById('ndRoomName').value.trim() || 'your room';
  const el  = document.getElementById('cdmNameplateTxt'); if (el) el.textContent = val;
}
...
function createCustomDoor() {
  ...
  ROOMS[roomId] = {
    wall: p.wall, floor: p.floor, win: p.win,
    curtain: p.door,
    glow: p.glow, pc: p.pc, accent: p.accent,
    duvet: p.duvet, lampshade: p.lamp, lampglow: p.lampg, rug: p.rug,
...
function buildRoom(d, roomId) {
  ...
  const mkBooks = arr => arr.map(b =>
    `<div class="sbook" style="--bc:${b.c};--bh:${b.h}px" data-t="${b.t}"></div>`
  ).join('');
...
function buildCollectionPanel(roomId) {
  ...
  panel.innerHTML = allItems.map(item =>
